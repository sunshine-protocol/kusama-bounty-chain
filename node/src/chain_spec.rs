...
fn seed_to_public<TPublic: Public>(
    seed: &str,
...
fn staging_chain_spec_genesis() -> GenesisConfig {
    ...
    let controller = &[
        ...
        hex![
            "8aee2acc755ee0a3e161db53b03fd988b0c8e00d8c09dbc4edd22b4523eeb868"
        ],
    ...
    let stash = &[
        ...
        hex![
            "980e4d3fb16f722e5f9af556fd4d0570d8012203db5de2b2c106b21590b26358"
        ],
    ...
    let session = &[
        ...
        hex![
            "3e8b532432f03543a7bd6ceaccc6469cdcce0d996728a2f84b9b76cec3ec66b9"
        ],
